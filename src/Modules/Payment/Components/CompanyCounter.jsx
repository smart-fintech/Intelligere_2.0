 ...
 *
 * The typing and the limits are NumberStepper's; the figure in `price` and
 * `unit` comes from the live quote - nothing is worked out here.
 */
export function CompanyCounter({ value, onChange, min = 1, max = MAX_COMPANY_QUANTITY, price, unit }) {
  return (
